...
vector<string> Utility::explode(string const& s, char delim)
{
...
string Utility::removeCharacter(string str, char ch)
{
	string result = str;
...
string Utility::GetConfigValue(string section, string param)
{
	...
	if (reader.ParseError() < 0) {
		FILE_LOG(logERROR) << "Can't load agent.conf";
		return "";
	}
